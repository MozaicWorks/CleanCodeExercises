...
namespace A.Tests
{
    ...
    public class TennisTests
    {
        ...
        {
            var game = new IC5("player1", "player2");
            CheckAllScores(game, p1, p2, expected);
        }

        private void CheckAllScores(IC5 game, int player1Score, int player2Score, string expectedScore)
        {
            ...
            Assert.Equal(expectedScore, game.M2());
        }
    }
}